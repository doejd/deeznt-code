...
function get_keywords(content)
    local keywords = {
        ...
        "canvas", "caption", "c", "center", "cite", "code", "col", "colgroup", "data", "datalist",
        ...
        "meta", "meter", "nav", "noframes", "noscript", "object", "ol", "optgroup", "option", "output",
        "p", "param", "picture", "pre", "progress", "q", "rp", "rt", "ruby", "s", "samp",
        "script", "search", "section", "select", "small", "source", "span", "strike", "strong", "sub",
