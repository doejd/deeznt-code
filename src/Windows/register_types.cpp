...
void initialize_WindowsHost_module(ModuleInitializationLevel p_level) {
    ...
    GDREGISTER_RUNTIME_CLASS(WindowsHost);
...
GDExtensionBool GDE_EXPORT terminalhost_library_init(GDExtensionInterfaceGetProcAddress p_get_proc_address, const GDExtensionClassLibraryPtr p_library, GDExtensionInitialization *r_initialization) {
    ...
    init_obj.register_initializer(initialize_WindowsHost_module);
    init_obj.register_terminator(uninitialize_WindowsHost_module);
